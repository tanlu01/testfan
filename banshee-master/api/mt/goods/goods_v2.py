...
class Goods_v2(Mt):
    ...
    #         "data": {
    #             "type": "object",
    #             "required": ["goods_id", "goods_name", 'short_name', 'thumb_url', 'ethumb',
    #                          'market_price', 'min_group_price', 'min_normal_price', 'min_price',
    #                          'sales', 'sales_text', 'sales_whole_text', 'mall_id', 'money_types',
    #                          'footnote', 'promotion_mark', 'import_mark', 'marks_front', 'marks_back',
    #                          'marks_rear', 'mall', 'service_promise_mark', 'rdata', 'show_price',
    #                          'goods_desc', 'gallery_carousel', 'gallery_detail', 'order_mode',
    #                          'group_buy_label', 'overlap', 'type', 'is_refundable', 'core_specs',
    #                          'skus', 'single', 'service_promises', 'cat_conf', 'share', 'deduction',
    #                          'coin_marks', 'promotion_marks', 'price_hint', 'promotions', 'price_bar',
    #                          'service_assurance', 'goods_marks', 'delivery_info', 'button_style',
    #                          'ui_elements'],
    #             "properties": {
    ...
    #                             'sku_price_bar': {
    #                                 'type': 'object',
    #                                 'required': ['t_min_price', 'react_values'],
    #                                 'properties': {
    #                                     "t_min_price": {"type": "string"},
    #                                     "react_values": {
    #                                         "type": "object",
    #                                         'required': ['final_price', 'line_price', 'price_currency', 'sold_text'],
    #                                         'properties': {
    #                                             "final_price": {"type": "string"},
    #                                             "line_price": {"type": "string"},
    ...
    #                         "values": {
    #                             "type": "object",
    #                             'required': ['start_time', 'end_time', 'final_price', 'final_desc',
    #                                          'final_currency', 'market_currency', 'tp_market_price',
    #                                          'react_values'],
    #                             'properties': {
    #                                 'start_time': {'type': 'number'},
    #                                 'end_time': {'type': 'number'},
    #                                 'final_price': {'type': 'string'},
    #                                 'final_desc': {'type': 'string'},
    #                                 'final_currency': {'type': 'string'},
    #                                 'market_currency': {'type': 'string'},
    #                                 'tp_market_price': {'type': 'string'},
    #                                 'react_values': {
    #                                     'type': 'object',
    #                                     'required': ['final_price', 'line_price', 'price_desc', 'price_currency',
    #                                                  'sold_text'],
    #                                     'properties': {
    #                                         'final_price': {'type': 'string'},
    #                                         'line_price': {'type': 'string'},
    ...
    #                 'ui_elements': {
    #                     'type': 'object',
    #                     'required': ['sku_desc_link', 'show_sku_pic', 'sku_pic_style', 'swap_review_module',
    #                                  'horizontally_review_style', 'button_color_type', 'brand_banner',
    #                                  'product_banner_type', 'product_information'],
    #                     'properties': {
    #                         'sku_desc_link': {
    #                             'type': 'object',
    #                             'required': ['name', 'link'],
