...
class Get_goods_list(Mt):
    method = 'get'
    api = '/v1/favorite/goods/list?offset=&size=20'
    data = {}
                    ...
                    "items": {
                        ...
                        'items': {
                            ...
                            'properties': {
                                ...
                                'break_payment_limit': {"type": "boolean"},
                                'mark_coll': {
                                    "type": "object",
                                    'required': [],
                                    'properties': {}
                                ...
                                'use_coupon': {'type': 'number'},
                                'group_customs': {'type': 'number'},
                                'is_onsale': {'type': 'boolean'},
                                'order_mode': {'type': 'number'},
                                'main_gallery_carousel': {'type': 'string'}
                            }
                        }
                    },
                    "offset": {"type": "string"}
